    ...
    <div>
      ...
      <div className="bg-blue-900 text-white py-8">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-2">Contáctanos</h2>
        </div>
      </div>
      
      {/* Contenido con fondo blanco */}
      <section id="contacto" className="bg-white text-gray-900 py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <motion.div variants={fadeInUp} className="text-center lg:text-left">
                <h3 className="text-2xl font-bold mb-6 text-blue-900">Sobre Nosotros</h3>
            ...
            >
              ...
              <motion.div variants={fadeInUp}>
                <h3 className="text-2xl font-bold mb-6 text-blue-900 flex items-center justify-center lg:justify-start">
                  <MapPin className="mr-3" size={28} />
                  Dirección
                </h3>
                <div className="bg-gray-100 rounded-lg p-6 text-center lg:text-left">
                  <a 
                    href="https://maps.google.com/?q=Carlos+Condell+117,+La+Cisterna"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xl hover:text-blue-600 transition-colors duration-200 flex items-center justify-center lg:justify-start text-gray-800"
                  >
                  ...
                  <div className="flex items-center justify-center lg:justify-start">
                    ...
                    <div className="text-lg">
                      ...
                      <div className="font-semibold">
                        <a href="tel:+56987005952" className="hover:text-blue-600 transition-colors text-gray-800">
                          +56 9 8700 5952
                        </a>
                      </div>
                    </div>
